                  ...
                  <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                      <div class="overflow-hidden">
                        <a href="{{ route('tipe_pekerjaan.create') }}">
                        ...
                        <table class="min-w-full border table-auto text-center text-sm font-light dark:border-neutral-500 mb-6">
                          ...
                          <tbody>
                            @foreach ($tipePekerjaan as $key=> $u)
                            <tr class="border-b dark:border-neutral-500">
                                ...
                                <td class="whitespace-nowrap border-r px-6 py-4 dark:border-neutral-500">
                                    <div>
                                        <a href="{{ route('tipe_pekerjaan.edit',['id'=>$u->id]) }}">
                                            <x-button type='button' >Edit</x-button>
                                        </a>
                                    </div>
                                    <div>
                                        <form action="{{ route('tipe_pekerjaan.destroy',['id'=>$u->id])}}" method="post">
                                            @csrf
                                            @method('delete')
